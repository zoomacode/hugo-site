...
def plot_weights_histogram(weights: list[float]):
    ...
    plt.savefig(
        "images/query-weights-distribution-naive.png", dpi=100
...
def print_distribution_of_query_ids(requests: list[int]):
    ...
    plt.savefig("images/query-ids-distribution-naive.png")
...
def main():
    ...
    plt.savefig("images/cache-eviction-lru-and-p2c-naive.png")
